---
name: brainstorming
description: "창의적 작업 전에 반드시 사용. 기능 생성, 컴포넌트 구축, 기능 추가, 동작 변경을 구현하기 전에 사용자 의도, 요구사항, 설계를 탐색한다."
---
...
5. **설계 문서 작성** - `docs/specs/YYYY-MM-DD-<topic>-design.md`에 저장하고 commit
...
- 가능하면 `elements-of-style:writing-clearly-and-concisely` 스킬을 사용한다.
...
> "`<path>`에 스펙을 작성하고 commit했습니다. 구현 계획 작성을 시작하기 전에 변경하고 싶은 부분이 있는지 검토해 주세요."
